exports.register = function (wss, playerInfoDaoMap, RankCol) {
		...
		ws.on('message', function(data, flag){
			...
			switch (dataId) {
				...
				case 'game.life':
					...
					// 		playerInfoDaoMap.push(playerInfoDao);
	...
	function deleteExistPlayerInfo (t_id) {
		for (var i in playerInfoDaoMap) {
			if (Number(playerInfoDaoMap[i].t_id) === Number(t_id)) {
...
//		console.log("in getRankInfo");
//		console.log(targetWs);
		var totalScore = 0;
		for (var i in targetWs.fishInfo) {
//			console.log("score");
//			console.log(targetWs.fishInfo[i].score);
